      ...
      <div className="h-screen relative">
        ...
        <div className="container mx-auto h-screen">
          <div className="absolute top-1/2 transform -translate-y-1/2">
            ...
            <p className="text-white text-center md:text-left text-lg mb-3">
              Seems that the NASA APOD API is slow right now. Please try again
              later!
            </p>
            <Link href="/">
              <i className="fa-solid fa-house text-center md:text-left text-3xl text-white" />
            </Link>
          </div>
